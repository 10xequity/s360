...
FAQ = [
 ...
 (None, 'Can I train without a membership?', 'Yes. A <strong>Drop-In</strong> session is $80 for non-members on the technology, booked in the Shoot 360 app up to 3 days ahead when space permits. Members add a session beyond their plan for $42. Drop-ins are technology only; coaching comes with a membership.'),
