...
FAQ = [
 ...
 (None, 'Can I train without a membership?', 'Yes. A <strong>Drop-In</strong> session is $80 for non-members on the technology, booked in the Shoot 360 app up to 3 days ahead when space permits. Members add a session beyond their plan for $42, and a member bringing a guest pays $10 for that guest\'s session. Drop-ins are technology only; coaching comes with a membership.'),
...
for f, key in PAGES.items():
    ...
    s = s.replace('"priceRange":"$72–$389"', '"priceRange":"$42–$389"').replace('"priceRange":"$42–$240"', '"priceRange":"$42–$389"')
...
<section class="sec sec-light" aria-labelledby="price-h">
  <div class="wrap">
    ...
    <div class="tiers mt2">
      ...
      <div class="tier reveal"><h3>Committed</h3><p class="fine">All-Star in the app</p><div class="visits">∞<small>unlimited sessions</small></div><div class="price">$389<small>/mo</small></div><ul><li>Coaching included · members' leagues</li><li>3-month commitment · day-time court access</li><li>Book 7 days ahead · extra sessions $0</li></ul><a class="btn btn-outline-dark btn-sm" href="https://www.shoot360.com/membership-checkout?locationid=5739019&amp;contractid=154" target="_blank" rel="noopener">Join</a></div>
      <div class="tier hot reveal"><span class="tag">Most popular</span><h3>Ball is Life</h3><p class="fine">Hall of Fame in the app</p><div class="visits">∞<small>unlimited sessions</small></div><div class="price">$379<small>/mo</small></div><ul><li>Coaching included · members' leagues · classes included</li><li>12-month commitment · day-time court access</li><li>Book 7 days ahead · extra sessions $0</li></ul><a class="btn btn-primary btn-sm" href="https://www.shoot360.com/membership-checkout?locationid=5739019&amp;contractid=156" target="_blank" rel="noopener">Join</a></div>
    </div>
    <p class="fine mt1">Also: <a href="memberships.html#classes">Unlimited Classes</a> and <a href="memberships.html#classes">Little Ballers</a> (ages 6–10) at $149/mo, <a href="memberships.html#more">Drop-In</a> sessions ($80, members $42), <a href="memberships.html#more">Lock-In Reserved</a> fixed weekly times, and a <a href="memberships.html#more">My Spark / DPS / APS</a> membership. One-time $40 enrollment fee; Aurora sales tax not included. Prices match Shoot 360's online checkout for Denver as of Sept 17, 2026; full contract terms are shown at signup.</p>
...
s = s.replace('<div class="faq-item"><button class="faq-q" type="button">Can I come once without joining?</button><div class="faq-a"><p>Yes. A guest workout is $72, and a 12-visit pack is $480 with no commitment. Drop-in times are booked in the app when space permits.</p></div></div>',
        '<div class="faq-item"><button class="faq-q" type="button">Can I come once without joining?</button><div class="faq-a"><p>Yes. A Drop-In session is $80 for non-members, booked in the Shoot 360 app up to 3 days ahead when space permits. Members add a session for $42. Drop-ins are technology only; coaching comes with a membership.</p></div></div>')  # v0.3 -> v0.4.1 (plain replace: the v0.4 text is handled just below)
s = s.replace('<p>Yes. A Drop-In session is <span class="tbd">$42</span>, booked in the Shoot 360 app up to 3 days ahead when space permits. Drop-ins are technology only; coaching comes with a membership.</p>',
              '<p>Yes. A Drop-In session is $80 for non-members, booked in the Shoot 360 app up to 3 days ahead when space permits. Members add a session for $42. Drop-ins are technology only; coaching comes with a membership.</p>')  # v0.4.1 owner answer
...
NEW_TIERS = "var tiers=[{name:'Varsity · 8 sessions',price:199,visits:8},{name:'Ball is Life · unlimited, 12-month',price:379,visits:null},{name:'Committed · unlimited',price:389,visits:null}];"
