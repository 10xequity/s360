...
<footer class="ft">
  <div class="wrap">
    <div class="cols">
      ...
      <div><h3>Hours</h3><ul><li>Mon – Fri: 2 – 9 PM</li><li>Sat – Sun: 10 AM – 5 PM</li><li>Homeschool: Mon – Fri 2 – 4 PM</li><li class="ft-app">Current schedule is in the <a href="technology.html#app">app</a></li></ul></div>
...
FAQ = [
 ...
 (None, 'What is a session, and how long is it?', 'A session is an hour on the technology: 30 minutes on a shooting bay, where automatic rebounding puts 300 or more measured shots up, and 30 minutes on a skills court for passing and ball-handling, with your coach reading the numbers with you. That hour is what a membership counts as one session, so JV\'s four sessions a month are four hours on the floor.'),
 (None, 'How often should my athlete train?', 'Two or three sessions a week is where players see steady improvement; once a week still shows in the numbers over a season. Varsity (8 sessions a month) fits twice a week, Committed and Ball is Life fit anything more. Members can always add a session for $40.'),
 ...
 ('q-memberships', 'How do memberships work?', 'Pick a hoop membership by how often you train: <strong>JV</strong> is 4 sessions a month ($159/mo), <strong>Varsity</strong> is 8 ($199/mo), <strong>Committed</strong> is unlimited ($239/mo) and <strong>Ball is Life</strong> is unlimited with classes included on a 12-month commitment ($230/mo). In the Shoot 360 app they appear as Rookie, Pro, All-Star and Hall of Fame. Every membership includes a coach during your sessions, the patented NBA technology, your stats in the app and Nike camp discounts. <a href="memberships.html#tiers">Compare tiers →</a>'),
 (None, 'What are Unlimited Classes and Little Ballers?', '<strong>Unlimited Classes</strong> is a classes-only membership ($149/mo, 1-month commitment): every coach-led group class on the schedule, all month, with stats in the app, members\' leagues and Nike camp discounts. <strong>Little Ballers</strong> is the same idea for ages 6–10: all classes, built for our youngest players. JV, Varsity and Committed members can add unlimited classes for $40 a month; Ball is Life includes them. <a href="memberships.html#classes">Details →</a>'),
 (None, 'Can I train without a membership?', 'Yes. A <strong>Drop-In</strong> session is <strong>$72</strong>, booked in the Shoot 360 app when space permits. That is the price for someone without a membership. It is not the same as a member adding an extra session on top of their plan, which is <strong>$40</strong>. Drop-ins are technology only; coaching comes with a membership.'),
 (None, 'Is coaching extra?', 'No. Every membership includes a coach on the floor during your sessions at no additional fee. Want dedicated one-on-one time? Ask your coach or email us; private training is arranged individually. <a href="memberships.html#coaching">How coaching works →</a>'),
 ...
 (None, 'Can I book back-to-back sessions?', 'Sessions are booked one at a time rather than back to back, so every member gets court time. Lock-In Reserved is the exception: it holds the same slot for you every week. Everything is booked in the Shoot 360 app.'),
 ...
 ('q-visit', 'Where are you, and when are you open?', f'Inside <a href="{FH}" target="_blank" rel="noopener">FieldhouseUSA</a> at 14200 E Alameda Ave, Aurora, CO 80012. Park in the FieldhouseUSA lot and come through the main entrance. Hours: Monday to Friday 2 to 9 PM, Saturday and Sunday 10 AM to 5 PM. Those shift around camps, leagues and events, and the <a href="technology.html#app">Shoot 360 app</a> always shows the current schedule. <a href="contact.html">Map and directions →</a>'),
 ...
 (None, 'Do you offer private training?', 'Yes. Coaching is already included in every membership; dedicated one-on-one blocks are arranged individually with a coach. Email <a href="mailto:info@shoot360denver.com?subject=Private%20training">info@shoot360denver.com</a> with the athlete\'s age, level and availability.'),
...
for f, key in PAGES.items():
    ...
    for old in ('"priceRange":"$72–$389"', '"priceRange":"$42–$389"'):  # v0.3 and v0.4.1 values
        s = s.replace(old, '"priceRange":"$40–$240"')  # Lock-In Reserved $240 is the dearest monthly
    s = s.replace('"priceRange":"$42–$240"', '"priceRange":"$40–$240"')  # v0.4.4 value
...
s = s.replace('Come evaluate. Memberships from $149/mo.', 'Come evaluate. Memberships from $159/mo.')  # v0.4.1: online prices; v0.3 text already said $159
...
<section class="sec sec-light" aria-labelledby="price-h">
  <div class="wrap">
    ...
    <div class="tiers mt2">
      <div class="tier reveal"><h3>JV</h3><p class="fine">Rookie in the app</p><div class="visits">4<small>sessions / month</small></div><div class="price">$159<small>/mo</small></div><ul><li>Coaching included</li><li>3-month commitment</li><li>Extra session $40</li></ul><a class="btn btn-outline-dark btn-sm" href="https://www.shoot360.com/membership-checkout?locationid=5739019&amp;contractid=151" target="_blank" rel="noopener">Join</a></div>
      <div class="tier reveal"><h3>Varsity</h3><p class="fine">Pro in the app</p><div class="visits">8<small>sessions / month</small></div><div class="price">$199<small>/mo</small></div><ul><li>Coaching included · members' leagues</li><li>3-month commitment</li><li>Extra session $40</li></ul><a class="btn btn-outline-dark btn-sm" href="https://www.shoot360.com/membership-checkout?locationid=5739019&amp;contractid=152" target="_blank" rel="noopener">Join</a></div>
      <div class="tier reveal"><h3>Committed</h3><p class="fine">All-Star in the app</p><div class="visits">∞<small>unlimited sessions</small></div><div class="price">$239<small>/mo</small></div><ul><li>Coaching included · members' leagues</li><li>3-month commitment · day-time court access</li><li>Extra sessions $0</li></ul><a class="btn btn-outline-dark btn-sm" href="https://www.shoot360.com/membership-checkout?locationid=5739019&amp;contractid=154" target="_blank" rel="noopener">Join</a></div>
      <div class="tier hot reveal"><span class="tag">Most popular</span><h3>Ball is Life</h3><p class="fine">Hall of Fame in the app</p><div class="visits">∞<small>unlimited sessions</small></div><div class="price">$230<small>/mo</small></div><ul><li>Coaching included · members' leagues · classes included</li><li>12-month commitment · day-time court access</li><li>Extra sessions $0</li></ul><a class="btn btn-primary btn-sm" href="https://www.shoot360.com/membership-checkout?locationid=5739019&amp;contractid=156" target="_blank" rel="noopener">Join</a></div>
    </div>
    <p class="fine mt1">Also: <a href="memberships.html#classes">Unlimited Classes</a> and <a href="memberships.html#classes">Little Ballers</a> (ages 6–10) at $149/mo, <a href="memberships.html#more">Drop-In</a> sessions ($72; members add a session for $40), <a href="memberships.html#more">Lock-In Reserved</a> fixed weekly times, and a <a href="memberships.html#more">My Spark / DPS / APS</a> membership. One-time $40 enrollment fee; Aurora sales tax not included. Prices as of Sept 19, 2026; full contract terms are shown at signup.</p>
...
s = s.replace('<div class="faq-item"><button class="faq-q" type="button">Can I come once without joining?</button><div class="faq-a"><p>Yes. A guest workout is $72, and a 12-visit pack is $480 with no commitment. Drop-in times are booked in the app when space permits.</p></div></div>',
        '<div class="faq-item"><button class="faq-q" type="button">Can I come once without joining?</button><div class="faq-a"><p>Yes. A Drop-In session is $72, which is the price for someone without a membership; members add a session on top of their plan for $40. Book either in the Shoot 360 app when space permits. Drop-ins are technology only; coaching comes with a membership.</p></div></div>')  # v0.3 -> v0.4.1 (plain replace: the v0.4 text is handled just below)
s = s.replace('<p>Yes. A Drop-In session is <span class="tbd">$42</span>, booked in the Shoot 360 app when space permits. Drop-ins are technology only; coaching comes with a membership.</p>',
              '<p>Yes. A Drop-In session is $72, which is the price for someone without a membership; members add a session on top of their plan for $40. Book either in the Shoot 360 app when space permits. Drop-ins are technology only; coaching comes with a membership.</p>')  # v0.4.1 owner answer
...
s = s.replace('<li>Hall of Fame and All-Star members: unlimited classes included</li>', '<li><strong>Unlimited Classes</strong> ($149/mo) and <strong>Little Ballers</strong> for ages 6–10: every class on the schedule, all month</li>')
s = s.replace('<li><strong>Unlimited Classes</strong> (<span class="tbd">$159</span>/mo) and <strong>Little Ballers</strong> for ages 6–10: every class on the schedule, all month</li>',
              '<li><strong>Unlimited Classes</strong> ($149/mo) and <strong>Little Ballers</strong> for ages 6–10: every class on the schedule, all month</li>')  # v0.4.1 owner answer
s = s.replace('<li>Rookie, Pro and non-members: register per class in the app at the rate shown there</li>', '<li>JV, Varsity and Committed members: add unlimited classes for $40/mo; Ball is Life includes them</li>')
s = s.replace('<li>JV, Varsity, Committed and Ball is Life members: add unlimited classes for $40/mo, or register per class in the app</li>',
              '<li>JV, Varsity and Committed members: add unlimited classes for $40/mo; Ball is Life includes them</li>')  # v0.4.1
...
NEW_TIERS = "var tiers=[{name:'Varsity · 8 sessions',price:199,visits:8},{name:'Ball is Life · unlimited, 12-month',price:230,visits:null},{name:'Committed · unlimited',price:239,visits:null}];"
s = s.replace("var tiers=[{name:'Pro · 8 visits',price:199,visits:8},{name:'Hall of Fame · unlimited',price:379,visits:null},{name:'All-Star · unlimited',price:389,visits:null}];", NEW_TIERS)
s = s.replace("var tiers=[{name:'Varsity · 8 sessions',price:189,visits:8},{name:'Committed · unlimited',price:229,visits:null},{name:'Ball is Life · unlimited, 12-month',price:220,visits:null}];", NEW_TIERS)  # v0.4 -> v0.4.1
assert NEW_TIERS in s, 'calculator tiers anchor missing'
JS4 = r'''
// ===== v0.4 =====================================================================
