...
FAQ = [
 ...
 (None, 'How often should my athlete train?', 'Two or three sessions a week is where players see steady improvement; once a week still shows in the numbers over a season. Varsity (8 sessions a month) fits twice a week, Committed and Ball is Life fit anything more. Members can always add a session for $42.'),
 ...
 (None, 'Can I train without a membership?', 'Yes. A <strong>Drop-In</strong> session is $80 for non-members on the technology, booked in the Shoot 360 app when space permits. Members add a session beyond their plan for $42, and a member bringing a guest pays $10 for that guest\'s session. Drop-ins are technology only; coaching comes with a membership.'),
...
for f, key in PAGES.items():
    ...
    for old in ('"priceRange":"$72–$389"', '"priceRange":"$42–$389"'):  # v0.3 and v0.4.1 values
        s = s.replace(old, '"priceRange":"$42–$240"')  # Lock-In Reserved $240 is the dearest monthly
...
<section class="sec sec-light" aria-labelledby="price-h">
  <div class="wrap">
    ...
    <p class="fine mt1">Also: <a href="memberships.html#classes">Unlimited Classes</a> and <a href="memberships.html#classes">Little Ballers</a> (ages 6–10) at $149/mo, <a href="memberships.html#more">Drop-In</a> sessions ($80, members $42), <a href="memberships.html#more">Lock-In Reserved</a> fixed weekly times, and a <a href="memberships.html#more">My Spark / DPS / APS</a> membership. One-time $40 enrollment fee; Aurora sales tax not included. Prices as of Sept 19, 2026; full contract terms are shown at signup.</p>
...
s = s.replace('<p>Yes. A Drop-In session is <span class="tbd">$42</span>, booked in the Shoot 360 app when space permits. Drop-ins are technology only; coaching comes with a membership.</p>',
              '<p>Yes. A Drop-In session is $80 for non-members, booked in the Shoot 360 app when space permits. Members add a session for $42. Drop-ins are technology only; coaching comes with a membership.</p>')  # v0.4.1 owner answer
